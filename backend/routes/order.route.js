...
import { createNewOrder, getAllOrders, getMyOrders, getOrder, updateOrderStatus } from "../controller/order.controller.js";
...
router.route("/updatestatus").patch(authAdmin, updateOrderStatus);
