  ...
  return (
    <DashboardLayout>
        ...
        <div className={styles.mainContainer}>
            ...
            <div className={styles.rightContainer}>
              ...
              <div className={styles.topBar}>
                <div className={styles.productInfo}>
                  <span className={styles.brand}>LUFA</span>
                  <span className={styles.catagory}> Tools & Accessoris </span>
                </div>
              ...
              <div className="priceBar">
                <div className="price">
                  <span>₹50</span>
                  <span className={styles.originalPrice}>₹57</span>
                  <span className={styles.pricenum}>you save ₹7</span>
                </div>
                <p>best message for skin</p>
          ...
          <div className={styles.mainReviewContainer}></div>
        </div>
    </DashboardLayout>
  );
}
